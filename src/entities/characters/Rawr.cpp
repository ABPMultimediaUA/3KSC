...
Rawr::Rawr(char* p_name, float p_position[3], bool p_debugMode) : Character(p_name, p_position, 100, 100, 15, 70.f, "assets/models/characters/rawr/rawr.obj", p_debugMode){
    m_maxProjectiles        = 1;
