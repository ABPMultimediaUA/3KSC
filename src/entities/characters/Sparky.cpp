...
Sparky::Sparky(char* p_name, float p_position[3], bool p_online, bool p_NPC) : Character(p_name, p_position, 450, 70, 65.f, "assets/models/characters/sparky/sparky.obj", p_online, p_NPC){
    m_type               = 4;
...
bool Sparky::specialAttackDown(){
    if(useMP(20) && !m_ultimateMode){
        ...
        m_system= m_engineManager->createParticleSystem("assets/spark.png", 10, -m_position[0], 10 - m_position[1], 10, 0.5, 0, 180, true, 1);
