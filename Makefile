...
INCLUDE := -I$(HDRDIR) -I$(INCDIR) -I$(INCDIR)irrlicht -I$(INCDIR)sfml -I$(INCDIR)box2D -I$(INCDIR)nlohmann -I$(INCDIR)raknet/raknet -I$(INCDIR)fmod -I$(INCDIR)OpenGL -I$(INCDIR)glm
